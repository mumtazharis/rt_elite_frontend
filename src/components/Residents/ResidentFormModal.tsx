                  ...
                  {formData.ktp && (
                    <div className="mt-2 p-3 bg-blue-50 border border-blue-100 rounded-lg flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-blue-800">File baru terpilih:</p>
                          <p className="text-xs text-blue-600 truncate max-w-[200px]">{formData.ktp.name}</p>
                        </div>
                      </div>
                      <button 
                        type="button"
                        onClick={() => setFormData({...formData, ktp: null})}
                        className="text-blue-800 hover:text-blue-900 text-xs font-bold"
                      >
                        Batal
                      </button>
                    </div>
